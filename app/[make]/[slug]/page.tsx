        ...
        <div>
              ...
              <ul className="space-y-2">
                {parts.map((item: AmazonItem) => (
                  <li key={item.amazonUrl}>
                    <a href={item.amazonUrl} target="_blank" rel="noopener noreferrer" className="text-red-600 hover:underline">
                      {item.name}
                    </a>
                  </li>
                ))}
          ...
          {video.transcript && (
            <section className="mb-6">
              ...
              <p className="text-gray-700 leading-relaxed text-sm">{video.transcript}</p>
            </section>
          )}
        </div>
